            ...
            <ul class="navbar-nav <?php echo ($lang === 'ar') ? 'me-auto' : 'ms-auto'; ?>" style="gap: 8px;">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="servicesDropdown" style="border: none !important; box-shadow: 0 8px 24px rgba(96, 34, 52, 0.2) !important; background-color: #FFFFFF !important; padding: 12px 0 !important; margin-top: 0 !important; min-width: 280px !important; border-top: 3px solid #602234 !important;">
                        <li><a class="dropdown-item" href="<?php echo SITE_URL; ?>/services.php?category=household" style="color: #602234 !important; padding: 12px 24px !important; font-size: 14px; transition: all 0.3s ease !important; display: flex; align-items: center; gap: 10px;"><i class="bi bi-house-door" style="font-size: 16px; color: #602234;"></i><?php echo $isArabic ? 'إدارة الممتلكات' : 'Household Management'; ?></a></li>
                        <li><a class="dropdown-item" href="<?php echo SITE_URL; ?>/services.php?category=events" style="color: #602234 !important; padding: 12px 24px !important; font-size: 14px; transition: all 0.3s ease !important; display: flex; align-items: center; gap: 10px;"><i class="bi bi-calendar-event" style="font-size: 16px; color: #602234;"></i><?php echo $isArabic ? 'إدارة الفعاليات' : 'Event Management'; ?></a></li>
                        <li><a class="dropdown-item" href="<?php echo SITE_URL; ?>/services.php?category=protocol" style="color: #602234 !important; padding: 12px 24px !important; font-size: 14px; transition: all 0.3s ease !important; display: flex; align-items: center; gap: 10px;"><i class="bi bi-award" style="font-size: 16px; color: #602234;"></i><?php echo $isArabic ? 'البروتوكول والإتيكيت' : 'Protocol & Etiquette'; ?></a></li>
                    </ul>
                </li>
                <li class="nav-item">
